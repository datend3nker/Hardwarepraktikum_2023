...
-- Design Ports Information
-- motor_signal1	=>  Location: PIN_K16,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- motor_signal2	=>  Location: PIN_J13,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- direction	=>  Location: PIN_B16,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- speed[9]	=>  Location: PIN_E16,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- speed[8]	=>  Location: PIN_E15,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- speed[7]	=>  Location: PIN_J15,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- speed[6]	=>  Location: PIN_J16,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- speed[5]	=>  Location: PIN_L16,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- speed[4]	=>  Location: PIN_G15,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- speed[3]	=>  Location: PIN_G16,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- speed[2]	=>  Location: PIN_K15,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- speed[1]	=>  Location: PIN_J14,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- speed[0]	=>  Location: PIN_L15,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
-- Equation(s):
-- \LessThan0~7_combout\ = (((!counter(2)) # (!counter(1))) # (!counter(9))) # (!counter(3))
...
-- Equation(s):
-- \LessThan0~8_combout\ = (((!counter(7)) # (!counter(4))) # (!counter(6))) # (!counter(5))
...
-- Equation(s):
-- \LessThan0~5_combout\ = (!counter(29) & (!counter(26) & (!counter(27) & !counter(28))))
...
-- Equation(s):
-- \LessThan0~1_combout\ = (!counter(16) & (!counter(14) & (!counter(15) & !counter(17))))
...
-- Equation(s):
-- \LessThan0~3_combout\ = (!counter(25) & (!counter(23) & (!counter(22) & !counter(24))))
...
-- Equation(s):
-- \LessThan0~2_combout\ = (!counter(20) & (!counter(21) & (!counter(19) & !counter(18))))
...
-- Equation(s):
-- \LessThan0~0_combout\ = (!counter(12) & (!counter(11) & (!counter(10) & !counter(13))))
...
-- Equation(s):
-- \LessThan0~4_combout\ = (\LessThan0~1_combout\ & (\LessThan0~3_combout\ & (\LessThan0~2_combout\ & \LessThan0~0_combout\)))
...
-- Equation(s):
-- \LessThan0~6_combout\ = (!counter(30) & (\LessThan0~5_combout\ & \LessThan0~4_combout\))
...
-- Equation(s):
-- \LessThan0~9_combout\ = ((!\LessThan0~7_combout\ & (counter(8) & !\LessThan0~8_combout\))) # (!\LessThan0~6_combout\)
...
-- Equation(s):
-- \LessThan1~5_cout\ = CARRY((counter(2) & (\speed[2]~input_o\ & !\LessThan1~3_cout\)) # (!counter(2) & ((\speed[2]~input_o\) # (!\LessThan1~3_cout\))))
...
-- Equation(s):
-- \LessThan1~17_cout\ = CARRY((counter(8) & (\speed[8]~input_o\ & !\LessThan1~15_cout\)) # (!counter(8) & ((\speed[8]~input_o\) # (!\LessThan1~15_cout\))))
...
-- Equation(s):
-- \LessThan1~20_combout\ = (!counter(30) & (\LessThan1~18_combout\ & (\LessThan0~5_combout\ & \LessThan0~4_combout\)))
...
-- Equation(s):
-- \motor_signal1~0_combout\ = (\LessThan1~20_combout\ & \direction~input_o\)
...
-- Equation(s):
-- \motor_signal2~0_combout\ = (\LessThan1~20_combout\ & !\direction~input_o\)
